...
; CHECK: encoding: [0x05,0x10,0x00,0x20]
cmpi.eq r1, 5
; CHECK-INST: cmpi.lo r1, 5
; CHECK: encoding: [0x05,0x10,0x00,0x21]
cmpi.lo r1, 5
; CHECK-INST: cmpi.ls r1, 5
; CHECK: encoding: [0x05,0x10,0x00,0x22]
cmpi.ls r1, 5
; CHECK-INST: cmpi.lt r1, 5
; CHECK: encoding: [0x05,0x10,0x00,0x23]
cmpi.lt r1, 5
; CHECK-INST: cmpi.le r1, 5
; CHECK: encoding: [0x05,0x10,0x00,0x24]
cmpi.le r1, 5

; CHECK-INST: cmp.eq r1, r5
; CHECK: encoding: [0x00,0x10,0x50,0x28]
cmp.eq r1, r5
; CHECK-INST: cmp.lo r1, r5
; CHECK: encoding: [0x00,0x10,0x50,0x29]
cmp.lo r1, r5
; CHECK-INST: cmp.ls r1, r5
; CHECK: encoding: [0x00,0x10,0x50,0x2a]
cmp.ls r1, r5
; CHECK-INST: cmp.lt r1, r5
; CHECK: encoding: [0x00,0x10,0x50,0x2b]
cmp.lt r1, r5
; CHECK-INST: cmp.le r1, r5
; CHECK: encoding: [0x00,0x10,0x50,0x2c]
cmp.le r1, r5
